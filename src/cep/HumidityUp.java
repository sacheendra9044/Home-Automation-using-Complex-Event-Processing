...
public class HumidityUp {
    ...
    public EPRuntime run() throws InterruptedException {
        ...
        cep = EPServiceProviderManager.getProvider("HumidityUpEngine", cepConfig);
    ...
    public static class CEPListener implements UpdateListener {
        public void update(EventBean[] newData, EventBean[] oldData) {
            ...
            System.out.println("Humidity low. Adjusting it up.");
            try {
                new MessageScreen("Humidity low at "+newData[0].get("a_sensorID")+". Adjusting it up.");
            } catch (InterruptedException ex) {
                Logger.getLogger(HumidityUp.class.getName()).log(Level.SEVERE, null, ex);
            }
